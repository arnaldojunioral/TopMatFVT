...
<img width="750" height="291" alt="image" src="https://github.com/user-attachments/assets/8ff29c57-1db2-4f12-8f63-6b51e6227403" />
...
| 5    | Santos Júnior, A.; Cavalcante, M. A. A. (2025). *Checkerboard-free topology optimization for cellular materials via the finite-volume theory.* *Optimization and Engineering*, p. 1573-2924. | ⭐⭐⭐ | Medium | Provides a comparative study between energy equivalence and mean-field theory approaches to topology optimization of periodic cellular materials. |
| 6    | Santos Júnior, A.; Cavalcante, M. A. A. (2024). *Topology optimization of periodic cellular materials employing the finite-volume theory.* *Engineering Optimization*, 57(7), p. 1952–1971. | ⭐⭐⭐ | Medium | Extends FVT-based topology optimization to periodic cellular microstructures employing the energy equivalence. |
...
| 8    | Araujo, M. V. O.; Santos Júnior, A.; Escarpini Filho, R. S.; Lages, E. N.; Cavalcante, M. A. A. (2024). *Top2dfvt: An efficient matlab implementation for topology optimization based on the finite-volume theory.* *F1000Research*, v. 13, p. 805. | ⭐⭐⭐ | Medium | Presents an open-access contribution on FVT-based topology optimization of two-dimensional structures, highlighting accessibility and reproducibility of methods. |
